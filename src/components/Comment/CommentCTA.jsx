...
import { deleteCommentHandler, dislikeCommentHandler, getIndividualPost, getPosts, likeCommentHandler } from '../../Hooks/slices/postSlice';
...
export const CommentCTA = ({ post, comment }) => {
    ...
    return <div className="like-comment-comment-page">
        ...
        {/* edit comment option */}
        {hasCommented && <EditIcon color="success" />}
